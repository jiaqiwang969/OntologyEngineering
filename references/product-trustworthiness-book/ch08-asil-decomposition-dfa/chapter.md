...
> **章首导读图（待生成）**
> 图片提示词：地面上两条整齐平行的管道各自独立延伸；剖面视角显示地面之下两条管道悄然汇入同一根粗总管。汇合点以琥珀色标示。
...
> **图 8-1（待生成）· 两条通道，一棵电源树**
> 图片提示词：上方两条并行的功能通道各成一列模块；向下延伸的供电线逐级汇聚，最终汇于同一个电源模块；该模块另有一条细控制线回连到左侧通道，形成不对称。汇聚点与控制线为琥珀色。
> 受控标签：主通道、监控通道、同一上游
