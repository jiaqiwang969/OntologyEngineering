...
正文见 [chapter.md](chapter.md)。本章保留情境、暴露、危害事件、分级依据、目标与重开依赖的可读论述、术语、方法和
合成教学案例；机器可执行语义不在本目录。

## 唯一执行绑定

- package id：`semantica.chapter_packages.vol2.ch14`
- primary scenario：`semantica.vol2.ch14.scenario.primary`
- manifest 状态：`partial`
- release 状态：`blocked`
