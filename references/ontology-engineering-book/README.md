...
├── ch01-introduction/             # 第1章：绪论——从哲学本体论到工程本体论
│   └── examples/
├── ch02-ontology-foundations/     # 第2章：本体论基础理论
│   └── examples/
├── ch03-ontology-methodology/     # 第3章：本体构建方法论
│   └── examples/
...
│   └── examples/
├── ch07-knowledge-graph/          # 第7章：知识图谱构建与管理
│   └── examples/
├── ch08-ontology-llm/             # 第8章：本体与大语言模型
│   └── examples/
└── ch09-capstone-manufacturing/   # 第9章：综合实战案例：智能制造知识管理系统
    └── src/
```

> **章节覆盖说明 / Chapter Coverage**：全书九章配套目录齐备。
