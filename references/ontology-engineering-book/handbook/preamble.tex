...
\newcommand{\chapterbinding}[5]{%
  ...
  书中代码框只解释语义；本章所列且\textbf{已经实现}的本体、CQ、SHACL、SPARQL、
  案例、规则、合同、输入夹具、oracle、版本、PROV 与 receipt，其可执行正本只在此包。
  \texttt{absent}、\texttt{missing} 或 \texttt{unsupported} 表示相应资产或能力尚不存在，
  不得从正文示意反推为已经实现。
...
\newcommand{\chapterart}[2]{%
  \begin{center}
    \IfFileExists{figures/#1.jpg}{%
      \includegraphics[width=0.62\linewidth]{figures/#1.jpg}\par\vspace{0.4em}%
...
\hypersetup{
  pdftitle={《工程本体论》·2026.08 Semantica 唯一执行语义候选版},
