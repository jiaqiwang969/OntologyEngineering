...
| Ch02 foundations | `ch02-ontology-foundations/README.md`, `examples/*.txt`, `handbook/chapters/ch02.tex` | Core concepts, classes/relations/instances, first-order logic, description logic, reasoning basics · runnable: `demos/vol1_ch02_reasoning_modes.py` |
| Ch03 methodology | `ch03-ontology-methodology/README.md`, `examples/*.txt`, `handbook/chapters/ch03.tex` | Ontology 101, METHONTOLOGY, competency questions, OntoClean evaluation · runnable: `demos/vol1_ch03_cq_acceptance.py` |
