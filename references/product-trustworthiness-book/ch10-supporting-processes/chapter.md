...
> **章首导读图（待生成）**
> 图片提示词：一张长会议桌上，纸页层层叠成一座稳固的塔；塔顶上方悬浮着一页纸，与塔身之间留有一段明显的空隙，空隙处以琥珀色虚线示意未连接。
...
冲击振动卡照旧支持局部件的可靠性小句，射程原样声明。走查那几周揪出的那路共享
...
> **图 10-1（待生成）· 主张在上，证据在下，中间的论证没人写**
> 图片提示词：三层金字塔式结构：顶层一块横幅（主张），底层一排整齐卡片（证据），中间层是一片明显的空缺，只有几条虚线试图连接上下。空缺层以琥珀色虚线框标出。
> 受控标签：主张、论证、证据
